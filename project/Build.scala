...
object MonocleBuild extends Build {
  ...
  val sourceMapOpt = {
    ...
    val g = "https://raw.githubusercontent.com/japgolly/Monocle/v1.1.0-js"
  ...
  lazy val defaultSettings = buildSettings ++ publishSettings ++ releaseSettings ++ ScalaJSPlugin.projectSettings
